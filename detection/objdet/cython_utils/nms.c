...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "objdet.cython_utils.nms", 
        "sources": [
            "objdet/cython_utils/nms.pyx"
        ]
    }, 
    "module_name": "objdet.cython_utils.nms"
}
END: Cython Metadata */
...
#define __PYX_HAVE__objdet__cython_utils__nms
#define __PYX_HAVE_API__objdet__cython_utils__nms
#include <string.h>
#include <stdio.h>
...
static float __pyx_f_6objdet_12cython_utils_3nms_overlap_c(float, float, float, float); /*proto*/
static float __pyx_f_6objdet_12cython_utils_3nms_box_intersection_c(float, float, float, float, float, float, float, float); /*proto*/
static float __pyx_f_6objdet_12cython_utils_3nms_box_union_c(float, float, float, float, float, float, float, float); /*proto*/
static float __pyx_f_6objdet_12cython_utils_3nms_box_iou_c(float, float, float, float, float, float, float, float); /*proto*/
...
#define __Pyx_MODULE_NAME "objdet.cython_utils.nms"
extern int __pyx_module_is_main_objdet__cython_utils__nms;
int __pyx_module_is_main_objdet__cython_utils__nms = 0;

/* Implementation of 'objdet.cython_utils.nms' */
...
/* "objdet/cython_utils/nms.pyx":11
...
static float __pyx_f_6objdet_12cython_utils_3nms_overlap_c(float __pyx_v_x1, float __pyx_v_w1, float __pyx_v_x2, float __pyx_v_w2) {
  float __pyx_v_l1;
  float __pyx_v_l2;
  float __pyx_v_left;
  float __pyx_v_right;
  ...
  /* "objdet/cython_utils/nms.pyx":14
 *     cdef:
 *         float l1,l2,left,right
 *     l1 = x1 - w1 /2.             # <<<<<<<<<<<<<<
 *     l2 = x2 - w2 /2.
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":15
 *         float l1,l2,left,right
 *     l1 = x1 - w1 /2.
 *     l2 = x2 - w2 /2.             # <<<<<<<<<<<<<<
 *     left = max(l1,l2)
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":16
 *     l1 = x1 - w1 /2.
 *     l2 = x2 - w2 /2.
 *     left = max(l1,l2)             # <<<<<<<<<<<<<<
 *     r1 = x1 + w1 /2.
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":17
 *     l2 = x2 - w2 /2.
 *     left = max(l1,l2)
 *     r1 = x1 + w1 /2.             # <<<<<<<<<<<<<<
 *     r2 = x2 + w2 /2.
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":18
 *     left = max(l1,l2)
 *     r1 = x1 + w1 /2.
 *     r2 = x2 + w2 /2.             # <<<<<<<<<<<<<<
 *     right = min(r1, r2)
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":19
 *     r1 = x1 + w1 /2.
 *     r2 = x2 + w2 /2.
 *     right = min(r1, r2)             # <<<<<<<<<<<<<<
 *     return right - left;
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":20
 *     r2 = x2 + w2 /2.
 *     right = min(r1, r2)
 *     return right - left;             # <<<<<<<<<<<<<<
 * 
...
/* "objdet/cython_utils/nms.pyx":26
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static float __pyx_f_6objdet_12cython_utils_3nms_box_intersection_c(float __pyx_v_ax, float __pyx_v_ay, float __pyx_v_aw, float __pyx_v_ah, float __pyx_v_bx, float __pyx_v_by, float __pyx_v_bw, float __pyx_v_bh) {
  float __pyx_v_w;
  float __pyx_v_h;
  float __pyx_v_area;
  float __pyx_r;
  ...
  /* "objdet/cython_utils/nms.pyx":29
 *     cdef:
 *         float w,h,area
 ...
 */
  __pyx_v_w = __pyx_f_6objdet_12cython_utils_3nms_overlap_c(__pyx_v_ax, __pyx_v_aw, __pyx_v_bx, __pyx_v_bw);

  /* "objdet/cython_utils/nms.pyx":30
 *         float w,h,area
 *     w = overlap_c(ax, aw, bx, bw)
 *     h = overlap_c(ay, ah, by, bh)             # <<<<<<<<<<<<<<
 *     if w < 0 or h < 0: return 0
 *     area = w * h
 */
  __pyx_v_h = __pyx_f_6objdet_12cython_utils_3nms_overlap_c(__pyx_v_ay, __pyx_v_ah, __pyx_v_by, __pyx_v_bh);

  /* "objdet/cython_utils/nms.pyx":31
 *     w = overlap_c(ax, aw, bx, bw)
 *     h = overlap_c(ay, ah, by, bh)
 *     if w < 0 or h < 0: return 0             # <<<<<<<<<<<<<<
 *     area = w * h
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":32
 *     h = overlap_c(ay, ah, by, bh)
 *     if w < 0 or h < 0: return 0
 *     area = w * h             # <<<<<<<<<<<<<<
 *     return area
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":33
 *     if w < 0 or h < 0: return 0
 *     area = w * h
 *     return area             # <<<<<<<<<<<<<<
 * 
...
/* "objdet/cython_utils/nms.pyx":39
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static float __pyx_f_6objdet_12cython_utils_3nms_box_union_c(float __pyx_v_ax, float __pyx_v_ay, float __pyx_v_aw, float __pyx_v_ah, float __pyx_v_bx, float __pyx_v_by, float __pyx_v_bw, float __pyx_v_bh) {
  float __pyx_v_i;
  float __pyx_v_u;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "objdet/cython_utils/nms.pyx":42
 *     cdef:
 *         float i,u
 ...
 *     return u
 */
  __pyx_v_i = __pyx_f_6objdet_12cython_utils_3nms_box_intersection_c(__pyx_v_ax, __pyx_v_ay, __pyx_v_aw, __pyx_v_ah, __pyx_v_bx, __pyx_v_by, __pyx_v_bw, __pyx_v_bh);

  /* "objdet/cython_utils/nms.pyx":43
 *         float i,u
 *     i = box_intersection_c(ax, ay, aw, ah, bx, by, bw, bh)
 *     u = aw * ah + bw * bh -i             # <<<<<<<<<<<<<<
 *     return u
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":44
 *     i = box_intersection_c(ax, ay, aw, ah, bx, by, bw, bh)
 *     u = aw * ah + bw * bh -i
 *     return u             # <<<<<<<<<<<<<<
 * 
...
/* "objdet/cython_utils/nms.pyx":51
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static float __pyx_f_6objdet_12cython_utils_3nms_box_iou_c(float __pyx_v_ax, float __pyx_v_ay, float __pyx_v_aw, float __pyx_v_ah, float __pyx_v_bx, float __pyx_v_by, float __pyx_v_bw, float __pyx_v_bh) {
  float __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("box_iou_c", 0);

  /* "objdet/cython_utils/nms.pyx":52
 * @cython.cdivision(True)
 * cdef float box_iou_c(float ax, float ay, float aw, float ah, float bx, float by, float bw, float bh):
 *     return box_intersection_c(ax, ay, aw, ah, bx, by, bw, bh) / box_union_c(ax, ay, aw, ah, bx, by, bw, bh);             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (__pyx_f_6objdet_12cython_utils_3nms_box_intersection_c(__pyx_v_ax, __pyx_v_ay, __pyx_v_aw, __pyx_v_ah, __pyx_v_bx, __pyx_v_by, __pyx_v_bw, __pyx_v_bh) / __pyx_f_6objdet_12cython_utils_3nms_box_union_c(__pyx_v_ax, __pyx_v_ay, __pyx_v_aw, __pyx_v_ah, __pyx_v_bx, __pyx_v_by, __pyx_v_bw, __pyx_v_bh));
  goto __pyx_L0;
...
/* "objdet/cython_utils/nms.pyx":61
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static PyObject *__pyx_f_6objdet_12cython_utils_3nms_NMS(__Pyx_memviewslice __pyx_v_final_probs, __Pyx_memviewslice __pyx_v_final_bbox) {
  ...
  /* "objdet/cython_utils/nms.pyx":62
 * @cython.cdivision(True)
 * cdef NMS(float[:, ::1] final_probs , float[:, ::1] final_bbox):
 *     cdef list boxes = list()             # <<<<<<<<<<<<<<
 *     cdef set indices = set()
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":63
 * cdef NMS(float[:, ::1] final_probs , float[:, ::1] final_bbox):
 *     cdef list boxes = list()
 *     cdef set indices = set()             # <<<<<<<<<<<<<<
 *     cdef:
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":68
 * 
 * 
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":69
 * 
 *     pred_length = final_bbox.shape[0]
 *     class_length = final_probs.shape[1]             # <<<<<<<<<<<<<<
 *     for class_loop in range(class_length):
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":70
 *     pred_length = final_bbox.shape[0]
 *     class_length = final_probs.shape[1]
 *     for class_loop in range(class_length):             # <<<<<<<<<<<<<<
 *         for index in range(pred_length):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "objdet/cython_utils/nms.pyx":71
 *     class_length = final_probs.shape[1]
 *     for class_loop in range(class_length):
 *         for index in range(pred_length):             # <<<<<<<<<<<<<<
 *             if final_probs[index,class_loop] == 0: continue
 ...
 */
    ...
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "objdet/cython_utils/nms.pyx":72
 *     for class_loop in range(class_length):
 *         for index in range(pred_length):
 *             if final_probs[index,class_loop] == 0: continue             # <<<<<<<<<<<<<<
 *             for index2 in range(index+1,pred_length):
 ...
 */
      ...
      /* "objdet/cython_utils/nms.pyx":73
 *         for index in range(pred_length):
 *             if final_probs[index,class_loop] == 0: continue
 *             for index2 in range(index+1,pred_length):             # <<<<<<<<<<<<<<
 *                 if final_probs[index2,class_loop] == 0: continue
 ...
 */
      ...
      for (__pyx_t_10 = (__pyx_v_index + 1); __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "objdet/cython_utils/nms.pyx":74
 *             if final_probs[index,class_loop] == 0: continue
 *             for index2 in range(index+1,pred_length):
 *                 if final_probs[index2,class_loop] == 0: continue             # <<<<<<<<<<<<<<
 *                 if index==index2 : continue
 ...
 */
        ...
        /* "objdet/cython_utils/nms.pyx":75
 *             for index2 in range(index+1,pred_length):
 *                 if final_probs[index2,class_loop] == 0: continue
 *                 if index==index2 : continue             # <<<<<<<<<<<<<<
 *                 if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.4:
 ...
 */
        ...
        /* "objdet/cython_utils/nms.pyx":76
 *                 if final_probs[index2,class_loop] == 0: continue
 *                 if index==index2 : continue
 *                 if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.4:             # <<<<<<<<<<<<<<
 *                     if final_probs[index2,class_loop] > final_probs[index, class_loop] :
 ...
 */
          ...
          if (__pyx_t_8) {
            ...
            /* "objdet/cython_utils/nms.pyx":78
 *                 if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.4:
 *                     if final_probs[index2,class_loop] > final_probs[index, class_loop] :
 *                         final_probs[index, class_loop] =0             # <<<<<<<<<<<<<<
 *                         break
 ...
 */
            ...
            *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_probs.data + __pyx_t_33 * __pyx_v_final_probs.strides[0]) )) + __pyx_t_34)) )) = 0.0;
            ...
            /* "objdet/cython_utils/nms.pyx":79
 *                     if final_probs[index2,class_loop] > final_probs[index, class_loop] :
 *                         final_probs[index, class_loop] =0
 *                         break             # <<<<<<<<<<<<<<
 *                     final_probs[index2,class_loop]=0
 ...
 */
          ...
          /* "objdet/cython_utils/nms.pyx":80
 *                         final_probs[index, class_loop] =0
 *                         break
 *                     final_probs[index2,class_loop]=0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "objdet/cython_utils/nms.pyx":82
 *                     final_probs[index2,class_loop]=0
 * 
 *             if index not in indices:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_8 = (__Pyx_PySequence_ContainsTF(__pyx_t_1, __pyx_v_indices, Py_NE)); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 82, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_37 = (__pyx_t_8 != 0);
      if (__pyx_t_37) {

        /* "objdet/cython_utils/nms.pyx":83
 * 
 *             if index not in indices:
 *                 bb=BoundBox(class_length)             # <<<<<<<<<<<<<<
 *                 bb.x = final_bbox[index, 0]
 ...
 */
        __pyx_t_38 = __Pyx_GetModuleGlobalName(__pyx_n_s_BoundBox); if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 83, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_38);
        __pyx_t_39 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_class_length); if (unlikely(!__pyx_t_39)) __PYX_ERR(0, 83, __pyx_L1_error)
        ...
        if (!__pyx_t_40) {
          __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_38, __pyx_t_39); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
          ...
          if (PyFunction_Check(__pyx_t_38)) {
            ...
            __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_38, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_38)) {
            PyObject *__pyx_temp[2] = {__pyx_t_40, __pyx_t_39};
            __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_38, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_40); __pyx_t_40 = 0;
            __Pyx_GOTREF(__pyx_t_1);
            __Pyx_DECREF(__pyx_t_39); __pyx_t_39 = 0;
          } else
          #endif
          {
            __pyx_t_41 = PyTuple_New(1+1); if (unlikely(!__pyx_t_41)) __PYX_ERR(0, 83, __pyx_L1_error)
            ...
            __pyx_t_39 = 0;
            __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_38, __pyx_t_41, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_1);
        ...
        /* "objdet/cython_utils/nms.pyx":84
 *             if index not in indices:
 *                 bb=BoundBox(class_length)
 *                 bb.x = final_bbox[index, 0]             # <<<<<<<<<<<<<<
 *                 bb.y = final_bbox[index, 1]
 ...
 */
        ...
        __pyx_t_43 = 0;
        __pyx_t_1 = PyFloat_FromDouble((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_42 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_43)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (__Pyx_PyObject_SetAttrStr(__pyx_v_bb, __pyx_n_s_x, __pyx_t_1) < 0) __PYX_ERR(0, 84, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "objdet/cython_utils/nms.pyx":85
 *                 bb=BoundBox(class_length)
 *                 bb.x = final_bbox[index, 0]
 *                 bb.y = final_bbox[index, 1]             # <<<<<<<<<<<<<<
 *                 bb.w = final_bbox[index, 2]
 ...
 */
        ...
        __pyx_t_45 = 1;
        __pyx_t_1 = PyFloat_FromDouble((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_44 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_45)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 85, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (__Pyx_PyObject_SetAttrStr(__pyx_v_bb, __pyx_n_s_y, __pyx_t_1) < 0) __PYX_ERR(0, 85, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "objdet/cython_utils/nms.pyx":86
 *                 bb.x = final_bbox[index, 0]
 *                 bb.y = final_bbox[index, 1]
 *                 bb.w = final_bbox[index, 2]             # <<<<<<<<<<<<<<
 *                 bb.h = final_bbox[index, 3]
 ...
 */
        ...
        __pyx_t_47 = 2;
        __pyx_t_1 = PyFloat_FromDouble((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_46 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_47)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 86, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (__Pyx_PyObject_SetAttrStr(__pyx_v_bb, __pyx_n_s_w, __pyx_t_1) < 0) __PYX_ERR(0, 86, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "objdet/cython_utils/nms.pyx":87
 *                 bb.y = final_bbox[index, 1]
 *                 bb.w = final_bbox[index, 2]
 *                 bb.h = final_bbox[index, 3]             # <<<<<<<<<<<<<<
 *                 bb.c = final_bbox[index, 4]
 ...
 */
        ...
        __pyx_t_49 = 3;
        __pyx_t_1 = PyFloat_FromDouble((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_48 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_49)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (__Pyx_PyObject_SetAttrStr(__pyx_v_bb, __pyx_n_s_h, __pyx_t_1) < 0) __PYX_ERR(0, 87, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "objdet/cython_utils/nms.pyx":88
 *                 bb.w = final_bbox[index, 2]
 *                 bb.h = final_bbox[index, 3]
 *                 bb.c = final_bbox[index, 4]             # <<<<<<<<<<<<<<
 *                 bb.probs = np.asarray(final_probs[index,:])
 ...
 */
        ...
        __pyx_t_51 = 4;
        __pyx_t_1 = PyFloat_FromDouble((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_50 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_51)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 88, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (__Pyx_PyObject_SetAttrStr(__pyx_v_bb, __pyx_n_s_c, __pyx_t_1) < 0) __PYX_ERR(0, 88, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "objdet/cython_utils/nms.pyx":89
 *                 bb.h = final_bbox[index, 3]
 *                 bb.c = final_bbox[index, 4]
 *                 bb.probs = np.asarray(final_probs[index,:])             # <<<<<<<<<<<<<<
 *                 boxes.append(bb)
 *                 indices.add(index)
 */
        __pyx_t_38 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_38);
        __pyx_t_41 = __Pyx_PyObject_GetAttrStr(__pyx_t_38, __pyx_n_s_asarray); if (unlikely(!__pyx_t_41)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_41);
        __Pyx_DECREF(__pyx_t_38); __pyx_t_38 = 0;
...
__pyx_t_38 = __pyx_memoryview_fromslice(__pyx_t_52, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_38);
        ...
        if (!__pyx_t_39) {
          __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_41, __pyx_t_38); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_38); __pyx_t_38 = 0;
          __Pyx_GOTREF(__pyx_t_1);
        } else {
          #if CYTHON_FAST_PYCALL
          if (PyFunction_Check(__pyx_t_41)) {
            ...
            __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_41, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_41)) {
            PyObject *__pyx_temp[2] = {__pyx_t_39, __pyx_t_38};
            __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_41, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_39); __pyx_t_39 = 0;
            __Pyx_GOTREF(__pyx_t_1);
            __Pyx_DECREF(__pyx_t_38); __pyx_t_38 = 0;
          } else
          #endif
          {
            __pyx_t_40 = PyTuple_New(1+1); if (unlikely(!__pyx_t_40)) __PYX_ERR(0, 89, __pyx_L1_error)
            ...
            __pyx_t_38 = 0;
            __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_41, __pyx_t_40, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_1);
        ...
        /* "objdet/cython_utils/nms.pyx":90
 *                 bb.c = final_bbox[index, 4]
 *                 bb.probs = np.asarray(final_probs[index,:])
 *                 boxes.append(bb)             # <<<<<<<<<<<<<<
 *                 indices.add(index)
 *     return boxes
 */
        __pyx_t_53 = __Pyx_PyList_Append(__pyx_v_boxes, __pyx_v_bb); if (unlikely(__pyx_t_53 == ((int)-1))) __PYX_ERR(0, 90, __pyx_L1_error)

        /* "objdet/cython_utils/nms.pyx":91
 *                 bb.probs = np.asarray(final_probs[index,:])
 *                 boxes.append(bb)
 *                 indices.add(index)             # <<<<<<<<<<<<<<
 *     return boxes
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_53 = PySet_Add(__pyx_v_indices, __pyx_t_1); if (unlikely(__pyx_t_53 == ((int)-1))) __PYX_ERR(0, 91, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  /* "objdet/cython_utils/nms.pyx":92
 *                 boxes.append(bb)
 *                 indices.add(index)
 *     return boxes             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_52, 1);
  __Pyx_AddTraceback("objdet.cython_utils.nms.NMS", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "objdet.cython_utils.nms.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "objdet.cython_utils.nms.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "objdet.cython_utils.nms.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "objdet.cython_utils.nms._memoryviewslice", /*tp_name*/
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_objdet__cython_utils__nms) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "objdet.cython_utils.nms")) {
      if (unlikely(PyDict_SetItemString(modules, "objdet.cython_utils.nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("NMS", (void (*)(void))__pyx_f_6objdet_12cython_utils_3nms_NMS, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init objdet.cython_utils.nms", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init objdet.cython_utils.nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
